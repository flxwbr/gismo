...
public:
                    ...
                    gsQuadRule<T> & rule)
    {
        ...
        md.flags = NEED_MEASURE | NEED_VALUE | NEED_JACOBIAN | NEED_2ND_DER | NEED_GRAD_TRANSFORM;
    }
                         ...
                         const gsMatrix<T>   & quNodes)
    {
        ...
        rhs_ptr2->deriv_into(md.points, m_rhs2Grad);
        rhs_ptr2->deriv2_into(md.points, m_rhs2Derivs2);
                         ...
                         gsVector<T> const & quWeights)
    {
        ...
        for (index_t k = 0; k < quWeights.rows(); ++k) // loop over quadrature nodes
        {
            ...
            transformDeriv2Hgrad(md, k, m_rhs2Grad, m_rhs2Derivs2, ph_approxDeriv2);
...
protected:
    ...
    gsMatrix<T> ph_approxSpaceLaplace, ph_approxDeriv2;
