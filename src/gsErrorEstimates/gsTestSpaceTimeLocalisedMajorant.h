...
@brief A class that contains all the utils for testing the space-time majorant
        for the locally stabilized space-time IgA scheme for the heat equation.
...
#include <gsErrorEstimates/gsNurbsCreatorExtended.h>
...
template <typename T>
std::vector<T>& operator*(const T mult, std::vector<T>& a)
{
    std::transform(a.begin(), a.end(), a.begin(), std::bind1st(std::multiplies <T> () , mult));
    return a;
}
template <typename T>
std::vector<T>& operator^(std::vector<T>& a, const T pow)
{
    std::transform(a.begin(), a.end(), a.begin(), [pow](T x) { return std::pow(x, pow);});
    return a;
}
...
namespace gismo {
    ...
    template<unsigned d>
    class gsTestSpaceTimeLocalisedMajorant {
    ...
    public:
        // Constructor
        gsTestSpaceTimeLocalisedMajorant(const unsigned _exampleNumber,
                                bool _isAdaptive,
                                bool _withMajorant,
                                bool _withMajorantOptimization,
                                bool _withResidualEstimator,
                ...
                withResidualEstimator(_withResidualEstimator),
        ...
        void gsSolveKhfhSystem(gsSpaceTimeLocalisedAssembler<real_t> &,
                               gsMatrix<>&,
                               gsMatrix<double>&,
                               int,
                               gsVector<real_t>&);

        void gsSolveKhwhfhSystem(gsSpaceTimeLocalisedAssembler<real_t> &,
                                 gsMatrix<> &,
                                 gsMatrix<> &,
                                 int,
                                 gsVector<real_t>& );
        ...
        void gsRecontructMajorantBasedOnOptimalFlux(int refCounter, gsMultiBasis<real_t> &basisY, int yDegree,
                                                    ...
                                                    const gsFunctionExpr<real_t> &fFunc, const gsFunctionExpr<real_t> &uFunc,
                                                    ...
                                                    std::vector<real_t> &mdDistr, std::vector<real_t> &majDistr, std::vector<real_t> &mIIdDistr,
                                                    const gsVector<real_t>& e0Vector,
                                                    int elemNum,
                                                    gsSpaceTimeLocalisedAssembler<real_t> &spaceTimeAssembler,
...
/*
        void gsRecontructMajorantBasedOnEquilibratedFlux(int, gsMultiBasis<real_t> &, int,
                                                         ...
                                                         int);
*/
        void gsRecontructV(int, gsSpaceTimeLocalisedAssembler<real_t> & , gsBoundaryConditions<> &,
                           gsMatrix<real_t> &,
                           gsMultiPatch<real_t> &,
                           gsField<> &,
                           gsVector<index_t> &,
                           ...
                           gsVector<double> &,
                           gsMatrix<double> &);
        void gsRecontructW(int, gsSpaceTimeLocalisedAssembler<real_t> &, gsBoundaryConditions<> &,
                           gsMatrix<real_t> &,
                           gsMultiPatch<real_t> &,
                           gsField<> &,
                           gsVector<index_t> &,
        ...
        void gsExecuteRefinement(gsSpaceTimeLocalisedAssembler<real_t> &,
                                 gsMultiBasis<real_t> &, gsSpaceTimeLocalisedAssembler<real_t> &,
        ...
        void gsLogTestResults(int vDegree, int yDegree, int wDegree,
                              ...
                              gsVector<real_t> &eSpaceTimeLocVector,
        ...
        void gsLogAssemblingSolvingTime(int refCount,
                                        ...
                                        gsVector<double> & timeAsmbMajII,
                                        gsVector<double> & timeAsmbSpaceTimeError);
        ...
        void gsLogRefinementIterationErrorReport(const int refCount, const gsVector<real_t> & hmaxVector, const gsVector<real_t> & hminVector,
                                                 ...
                                                 const gsVector<real_t> & eSpaceTimeVector, const gsVector<real_t> & eFullSpaceTimeVector, const gsVector<real_t> & eSpaceTimeLocVector,
                                                 const gsVector<real_t> & eSpaceTimeSolOperVector, const gsVector<real_t> & eFullSpaceTimeSolOperVector,
                                                 const gsVector<real_t> & eIdentVector, const gsVector<real_t> & eFullIdentVector, const gsVector<real_t> & residualVector,
        ...
        void gsSaveToFileDivDivMMMatrices(bool, gsSparseMatrix<real_t> &, gsSparseMatrix<real_t> &, int refCounter);

        void gsSaveToFileKMatrix(bool, gsSpaceTimeLocalisedAssembler<real_t> &, int refCounter);
        ...
        void interpolateToRefVectorWithDirichletBC(const gsSpaceTimeLocalisedAssembler<real_t> &,
                                                   const gsMultiPatch<> &,
                                                   gsMatrix<> &,
                                                   gsMatrix<> &);
    ...
    public:
        ...
        const bool withResidualEstimator;
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::initGivenProblemData() {
        ...
        switch (d) {
            case 2:
                ...
                if (exampleNumber == 2 || exampleNumber == 3 || exampleNumber == 4 ||
                    ...
                    domainName = "rectangle $(0, 2) \\times (0, 1)$";
                           ...
                           exampleNumber == 35 || exampleNumber == 37 || exampleNumber == 38 || exampleNumber == 40 ||
                           exampleNumber == 41 || exampleNumber == 43){
                    // --------------------------------------------------------------------------------
                    //  Rectangular domains examples
                    // --------------------------------------------------------------------------------
                ...
                else if (exampleNumber == 39 || exampleNumber == 44) {

                    // --------------------------------------------------------------------------------
                    //  G-shape domain (inscribed in unit cube)
                    // --------------------------------------------------------------------------------
                    // std::string fileSrc = gsFileManager::find( "/Users/smatculevich/Dropbox/science/gismo-2018/devel/filedata/planar/stool2d_bspline.xml" );
                    // std::string fileSrc = gsFileManager::find( "/Users/smatculevich/Dropbox/science/gismo-2018/devel/filedata/planar/lshape2d_1patch_C1_p1.xml" );
                    // TODO: add where the gsNurbsCreator is changed:
                    //patches = *gsNurbsCreator<>::BSplineRectangleCurved();
                    patches = *gsNurbsCreatorExtended<real_t>::BSplineRectangleCurved();
                    cFriedrichs = 1.0 / (math::sqrt((real_t) dim) * PI);
                    domainName = "curved-square-shape domain";

                } else if (exampleNumber == 42) {

                    // TODO: add where the gsNurbsCreator is changed:
                    real_t low_x(0.0), low_y(0.0), upp_x(1.0), upp_y(2.0);
                    //patches = *gsNurbsCreator<>::BSplineRectangleWithIncreasedMultiplicity(low_x, low_y, upp_x, upp_y);
                    patches = *gsNurbsCreatorExtended<real_t>::BSplineRectangleWithIncreasedMultiplicity(low_x, low_y, upp_x, upp_y);
                    //patches = *gsNurbsCreator<>::BSplineRectangle();
                    cFriedrichs = 1 / PI;   // cFriedrichs <= 1 / (pi * sqrt(l_1^{-2} + ... + l_n^{-2}));
                    domainName = "rectangle $(0, 1) x (0, 2)$";
                }
                break;
            ...
            case 3:
                ...
                else if (exampleNumber == 15)
                {
                    ...
                    // std::string fileSrc = gsFileManager::find( "/Users/smatculevich/Dropbox/science/gismo-2018/devel/filedata/planar/stool2d_bspline.xml" );
                    // std::string fileSrc = gsFileManager::find( "/Users/smatculevich/Dropbox/science/gismo-2018/devel/filedata/planar/lshape2d_1patch_C1_p1.xml" );
                    // patches = *gsNurbsCreator<>::BSplineCubeCurved();
                    patches = *gsNurbsCreatorExtended<real_t>::BSplineCubeCurved();
                    cFriedrichs = 1.0 / (math::sqrt((real_t) dim) * PI);
                    domainName = "curved-cube domain";
        ...
        switch (exampleNumber) {
            ...
            case 40:
                uExpr = "sin(pi*x)*sin(pi*y)*sin(pi*z)";
                fExpr = "( pi* sin(pi*x) * sin(pi*y) ) *( cos(pi*z) + 2 * pi*sin(pi*z) )";
                uDExpr = uExpr;
                break;
            case 41:
                uExpr = "if( y < 1, sin(pi*x)*(1 - y)^(2/3), "
                        "           if(y == 1, 0, sin(pi*x)*(y - 1)^(2/3))"
                        ")";
                fExpr = "if( y < 1, -(sin(pi*x)*(3*y*pi^2 - 3*pi^2 + 2))/(3*(1 - y)^(1/3)) , "
                        "           if(y == 1, 0, (sin(pi*x)*(3*y*pi^2 - 3*pi^2 + 2))/(3*(y - 1)^(1/3))  )"
                        ")";
                uDExpr = uExpr;
                break;
            case 42:
                uExpr = "if( y <= 1, sin(pi*x)*(1 - y), sin(pi*x)*(y - 1))";
                fExpr = "if( y <= 1, -sin(pi*x)*(y*pi^2 - pi^2 + 1), "
                        "            sin(pi*x)*(y*pi^2 - pi^2 + 1))";
                uDExpr = uExpr;
                break;
            case 43:
                uExpr = "x^(5/2)*(1-x)*y^(3/4)";
                fExpr = "if( y > 0, -(x^(1/2)*(3*x^3 - 3*x^2 - 35*y*x + 15*y))/(4*y^(1/4)), 0)";
                uDExpr = uExpr;
                break;
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsCreateResultsFolder(bool save,
                                                           int vDegree, int yDegree, int wDegree,
                                                           int yBasisRefDelay, int wBasisRefDelay,
                                                           int numTotalAdaptRef, MarkingStrategy adaptRefCrit,
                                                           real_t markingParamTheta) {
        if (save) {
            std::string folder = "localised-space-time-example-" + util::to_string(exampleNumber)
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogProblemData() {
        gsInfo << "%-------------------------------------------------------------------------------------------------%\n";
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogRefinementBasisInfo(int refCounter, const int numPatches, int numTotalAdaptRef,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsInitializeProblemData(gsFunctionExpr<> &uDFunc, gsFunctionExpr<> &fFunc,
    ...
    template<unsigned d>
    void
    gsTestSpaceTimeLocalisedMajorant<d>::gsCalculateDistribution(gsNorm<real_t> &residual,
...
/*
    template<unsigned d>
    void
    gsTestSpaceTimeLocalisedMajorant<d>::gsCalculateDistribution(gsEstimator<real_t> &residual,
                                                        std::vector<real_t> &resDistr,
                                                        int elemNum,
                                                        gsVector<real_t> &resValsVector,
                                                        gsVector<double> &timeAsmb,
...
*/
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsRecontructMajorantBasedOnOptimalFlux(int refCounter,
                                                                            gsMultiBasis<real_t> &basisY, int yDegree,
                                                                            gsMatrix<real_t> &yVector, gsMultiPatch<real_t> &mpY,
                                                                            gsVector<index_t> &yDOFs,
                                                                            const gsMultiPatch<real_t> &mpV, const gsField<> &v,
...
#pragma omp section
                    ...
                    {
                        if (theta != 0.0) {
                            gsErrEstDivDualDeltaKSpaceTimeMajorant<real_t> divmdDeltaKIndicator(v, mpY);
                            clock.restart();
                            divmdDeltaK = divmdIndicator.compute(false, elemNum);
                    ...
                    */
                    ...
                    #pragma omp section
                    {
                        gsErrEstEquilDeltaKSpaceTimeMajorant<real_t> meqDeltaKIndicator(v, y, fFunc);
                        clock_1.restart();
                        mEqDeltaK = meqIndicator.compute(false, elemNum);
                        timeAsmblMeq += clock_1.stop();
                        gsInfo << "time for element-wise evaluation of the mEq: " << timeAsmblMeq << " sec.\n";
                    }
                    */
...
#pragma omp section
                ...
                std::vector<real_t> mdDistr_, meqDistr_;
                mdDistr_.reserve(mdDistr.size());
                meqDistr_.reserve(meqDistr.size());

                std::transform(mdDistr.begin(), mdDistr.end(), meqDistr.begin(), std::back_inserter(majDistr),
                               [beta, this](const real_t & x, const real_t & y) {
                                   return math::sqrt((1 + beta) * math::pow(x, 2) + (1 + 1 / beta) * math::pow(this->cFriedrichs * y, 2)); } );
...
#pragma omp section
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsRecontructV(int refCount,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsRecontructW(int refCounter,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsGenerateDivMatrixRhs(int refCounter,
                                                            const gsDivPdeRhsFVt<real_t> &divPde,
                                                            const gsMultiBasis<real_t> &basisY, int yDegree,
                                                            gsVector<index_t> &yDOFs,
                                                            gsAssembler<> &divdivAssembler,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsGenerateMMMatrixRhs(int refCounter,
                                                           const gsPoissonPde<> &dualPde,
                                                           const gsMultiBasis<real_t> &basisY, int yDegree,
                                                           gsVector<index_t> &yDOFs,
                                                           gsAssembler<> &dualAssembler,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogTestResults(int vDegree, int yDegree, int wDegree,
                                                      int m, int l,
                                                      int yBasisRefDelay, int wBasisRefDelay,
                                                      real_t markingParamTheta, int numInitUniformRef, int numTotalAdaptRef,
                                                      gsVector<index_t> &vDOFs, gsVector<index_t> &yDOFs, gsVector<index_t> &wDOFs,
        ...
        */
        ...
        for (int refCounter = 0; refCounter < numTotalAdaptRef; ++refCounter) {
            std::printf("%4u & %10u & %10u & %10u & %10.2e & %10.2e & %10.2e & %16.2e & %16.2e & %16.2e & %16.2f \\\\\n",
                        ...
                        ( ( (timeAsmbY[refCounter] > timeAsmbW[refCounter]) ? timeAsmbY[refCounter] : timeAsmbW[refCounter] )
                         + ( (timeSolvY(refCounter, 0) > timeSolvW(refCounter, 0)) ? timeSolvY(refCounter, 0) : timeSolvW(refCounter, 0)) ));
        }
        gsInfo << "---------------------------------------------------------------------------------------\\\\\n";
        std::printf(" \t & \t & \t & \t & %10.2f & %10.2f & %10.2f & %16.2f & %16.2f & %16.2f & %16.2f \\\\\n",
                    ...
                    ( ( (timeAsmbY[lastRefIndx] > timeAsmbW[lastRefIndx]) ? timeAsmbY[lastRefIndx] : timeAsmbW[lastRefIndx] )
                      + ( (timeSolvY(lastRefIndx, 0) > timeSolvW(lastRefIndx, 0)) ? timeSolvY(lastRefIndx, 0) : timeSolvW(lastRefIndx, 0)) ));
        ...
        for (int refCounter = 0; refCounter < numTotalAdaptRef; ++refCounter) {
            std::printf("%4u & %10u & %10u & %10u & %10.2e & %10.2e & %10.2e & %16.2e & %16.2e & %16.2e & %16.2f \\\\\n",
                        ...
                        (timeAsmbV[refCounter] + timeSolvV(refCounter, 0)) /
                        ( ( (timeAsmbY[refCounter] > timeAsmbW[refCounter]) ? timeAsmbY[refCounter] : timeAsmbW[refCounter] )
                          + ( (timeSolvY(refCounter, 1) > timeSolvW(refCounter, 1)) ? timeSolvY(refCounter, 1) : timeSolvW(refCounter, 1)) ));
        }
        gsInfo << "---------------------------------------------------------------------------------------\\\\\n";
        std::printf(" \t & \t & \t & \t & %10.2f & %10.2f & %10.2f & %16.2f & %16.2f & %16.2f & %16.2f \\\\\n",
                    timeAsmbV[lastRefIndx] / timeAsmbW[lastRefIndx],
                    ...
                    (timeAsmbV[lastRefIndx] + timeSolvV(lastRefIndx, 0)) /
                    ( ( (timeAsmbY[lastRefIndx] > timeAsmbW[lastRefIndx]) ? timeAsmbY[lastRefIndx] : timeAsmbW[lastRefIndx] )
                      + ( (timeSolvY(lastRefIndx, 1) > timeSolvW(lastRefIndx, 1)) ? timeSolvY(lastRefIndx, 1) : timeSolvW(lastRefIndx, 1)) ));
        ...
        gsInfo << "\n REF & || grad_x e || &   \t maj & I_{eff}(maj) & majII/gap & I(majII / gap) & "
               << " \t ||| e |||_L &      idt & I_eff(idt) &  "
               << " \t ||| e |||_loc &  order(||| e |||_loc) &  order(||| e |||_L) \\\\\n";
        for (int refCounter = 0; refCounter < lastRefIndx; ++refCounter) {
            std::printf("%4u & %14.4e & %12.4e & %12.2f & %12.4e & %12.2f & %14.4e & %12.4e & %12.2f & %14.4e & %8.2f & %8.2f \\\\\n",
                        refCounter + 2,
                        ...
                        cast<real_t, double>(eSpaceTimeLocVector[refCounter + 1]),
                        cast<real_t, double>(math::log(eSpaceTimeLocVector[refCounter + 1] / eSpaceTimeLocVector[refCounter]) /
        ...
        gsInfo << "\n REF & || grad_x e || & I_{eff}(maj) & I(majII / gap) & ||| e |||_L & I_eff(idt) &  "
               << " \t ||| e |||_loc &  order(||| e |||_loc) &  order(||| e |||_L) \\\\\n";
        for (int refCounter = 0; refCounter < lastRefIndx; ++refCounter) {
            std::printf("%4u & %14.4e & %12.2f & %12.2f & %14.4e & %12.2f & %14.4e & %8.2f & %8.2f \\\\\n",
                        refCounter + 2,
                        cast<real_t, double>(eSpaceTimeSpaceGradVector[refCounter + 1]),
                        cast<real_t, double>(majVector[refCounter + 1] / eSpaceTimeSpaceGradVector[refCounter + 1]),
                        cast<real_t, double>(majIIVector[refCounter + 1] / majIIGapVector[refCounter + 1] / eSpaceTimeSpaceGradVector[refCounter + 1]),
        ...
        gsInfo << "\n REF & \t maj & I_{eff}(maj) & majII/gap & I(majII / gap) & "
               << " \t idt & I_eff(idt) &  order(||| e |||_loc) &  order(||| e |||_L) \\\\\n";
        for (int refCounter = 0; refCounter < lastRefIndx; ++refCounter) {
            std::printf("%4u & %12.4e & %12.2f & %12.4e & %12.2f & %12.4e & %12.2f & %8.2f & %8.2f \\\\\n",
                        refCounter + 2,
                    //cast<real_t, double>(eSpaceTimeSpaceGradVector[refCounter + 1]),
                        cast<real_t, double>(majVector[refCounter + 1]),
                        cast<real_t, double>(majVector[refCounter + 1] / eSpaceTimeSpaceGradVector[refCounter + 1]),
        ...
        gsInfo << "\n REF &  DOFs(v) & || grad_x e || & I_{eff}(maj) & I(majII / gap) & ||| e |||_loc &  order(||| e |||_loc) \\\\\n";
        for (int refCounter = 0; refCounter < lastRefIndx; ++refCounter) {
            std::printf("%4u & %10u & %14.4e & %12.2f & %12.2f & %14.4e & %8.2f \\\\\n",
                        refCounter + 2,
                        vDOFs[refCounter],
                        cast<real_t, double>(eSpaceTimeSpaceGradVector[refCounter + 1]),
                        cast<real_t, double>(majVector[refCounter + 1] / eSpaceTimeSpaceGradVector[refCounter + 1]),
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogAssemblingSolvingTime(int refCount,
                                                                gsVector<double> & timeAsmbDivDivY,
                                                                gsVector<double> & timeAsmbY,
                                                                gsVector<double> & timeAsmbW,
                                                                gsVector<double> & timeAsmbMMY,
        ...
        gsInfo << "time for element-wise evaluation of the minorant:           " << timeAsmbMajII[refCount] << " sec.\n";
        gsInfo << "time for element-wise evaluation of the error:              " << timeAsmbSpaceTimeError[refCount] << " sec.\n";
    }
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogRefinementIterationErrorReport(const int refCount, const gsVector<real_t> & hmaxVector, const gsVector<real_t> & hminVector,
                                                                         const gsVector<real_t> & eL2Vector, const gsVector<real_t> & eH1Vector,
                                                                         const gsVector<real_t> & eSpaceTimeSpaceGradVector, const gsVector<real_t> & eFullSpaceTimeSpaceGradVector,
                                                                         const gsVector<real_t> & ehQVector, const gsVector<real_t> & eFullSpaceTimeVector, const gsVector<real_t> & eSpaceTimeLocVector,
                                                                         const gsVector<real_t> & eSpaceTimeSolOperVector, const gsVector<real_t> & eFullSpaceTimeSolOperVector,
                                                                         const gsVector<real_t> & eIdentVector, const gsVector<real_t> & eFullIdentVector, const gsVector<real_t> & residualVector,
                                                                         const gsVector<real_t> & gradxe0Vector, const gsVector<real_t> & gradxeTVector,
        ...
        gsInfo << "(|| grad_x e ||^2_Q + || e ||^2_T + 1/2 * sum_{K} delta_K * || e_t ||^2_K)^1/2 = " << eSpaceTimeLocVector[refCount] << "\n";
        ...
        gsInfo << "(sum h^2_K * || delta_x v + f - v_t ||^2)^1/2         = " << residualVector[refCount] << "\n\n";
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogRefinementIterationInfo(int refCounter,
                                                                  gsVector<index_t> &vDOFs, gsVector<index_t> &yDOFs, gsVector<index_t> &wDOFs,
        ...
        gsInfo //<< "min   = " << minVector[refCounter] << "\t"
                ...
                //
                << "||| e |||_loc = " << eSpaceTimeLocVector[refCounter] << "\n"
                << "majh        = " << majhVector[refCounter] << "\t"
                << "iEff(majh) = " << majhVector[refCounter] / eSpaceTimeLocVector[refCounter] << "\n\n"
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsInitializeBasis(int degree,
        ...
        if (isAdaptive) {
            ...
            gsHBSplineBasis<d, real_t> hbBasis(tensorBSplineBasis);
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsGetInitialBasis(int vDegree, int yDegree, int wDegree,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsLogGeometryBasisData(gsGeometry<> &pGeom,
     ...
     */
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsExecuteRefinement(gsSpaceTimeLocalisedAssembler<real_t> &spaceTimeAssemblerV,
                                                         gsMultiBasis<real_t> &thbMultBasisY, gsSpaceTimeLocalisedAssembler<real_t> &spaceTimeAssemblerW,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsSaveToFileRefinementIterationInfo(bool save,
                                                                         const gsField<> &v,
                                                                         gsMultiBasis<> &basis,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsSaveToFileTestResults(bool save,
                                                             gsVector<index_t> &vDOFs, gsVector<index_t> &yDOFs, gsVector<index_t> &wDOFs,
                                                             gsVector<real_t> &eL2Vector, gsVector<real_t> &eH1Vector,
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsSaveToFileDivDivMMMatrices(bool save,
...
#pragma omp section
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsSaveToFileKMatrix(bool save,
                                                                  gsSpaceTimeLocalisedAssembler<real_t> &assembler,
                                                                  int refCounter) {
        {
            if (save) {
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsSolveKhfhSystem(gsSpaceTimeLocalisedAssembler<real_t>& assembler,
                                                       gsMatrix<>& vVector,
                                                       gsMatrix<double>& timeSolvV,
                                                       int refCounter,
                                                       gsVector<real_t>& stopcritVector) {
...
#pragma omp section
    ...
    template<unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>::gsSolveKhwhfhSystem(gsSpaceTimeLocalisedAssembler<real_t>& assembler,
...
#pragma omp section
    ...
    template <unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>:: gsSolveMajorantOptimalSystem(gsSparseMatrix<real_t> & yM, gsMatrix<real_t> & yRhs, gsMatrix<real_t> & yVector,
...
#pragma omp section
    ...
    template <unsigned d>
    void gsTestSpaceTimeLocalisedMajorant<d>:: interpolateToRefVectorWithDirichletBC(const gsSpaceTimeLocalisedAssembler<real_t> & assembler,
