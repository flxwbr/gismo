/** @file gsVisitorLocalisedSpaceTime.h
    ...
    @brief Heat equation element visitor corresponding to the locally-stabilised IgA space-time scheme.
...
/** \brief Visitor corresponding to the locally-weighted IgA space-time scheme
