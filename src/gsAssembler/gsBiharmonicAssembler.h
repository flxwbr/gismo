...
// Pascal
    template <class T, class bhVisitor>
    void gsBiharmonicAssembler<T,bhVisitor>::push()
    {
        for (size_t np = 0; np < m_ppde.domain().nPatches(); ++np)
        {
...
// Pascal
    template <class T, class bhVisitor>
    void gsBiharmonicAssembler<T,bhVisitor>::apply(bhVisitor & visitor,
                               size_t patchIndex,
                               boxSide side)
    {
...
#pragma omp critical(localToGlobal)
    ...
    // Pascal
    template <class T, class bhVisitor>
    void gsBiharmonicAssembler<T,bhVisitor>::constructSolution(const gsMatrix<T>& solVector,
    ...
    template <class T, class bhVisitor>
    void gsBiharmonicAssembler<T,bhVisitor>::constructG1Solution(const gsMatrix<T>& solVector,
...
template <class T, class bhVisitor>
void gsBiharmonicAssembler<T,bhVisitor>::plotParaview(gsField<> &solField_interior, gsMatrix<T> &result)
{
